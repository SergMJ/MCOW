...
with col2: 
    with st.container(horizontal=True):
        ...
        st.session_state.countries_list = countries     # Countries without alpha code are ommitted because of flag conflicts.
        
        st.session_state.countries_full_list = {k.capitalize().replace("-", " "):v for k, v in st.session_state.mcow_analyser.get_countries_dict().items()}     # Al stored
